...
import { LucideBell, LucideCalendarDays, LucideClock, LucideHeart, LucideSmilePlus, LucideSparkles } from '@lucide/angular';
import { Api } from '../../core/api';
import { Auth } from '../../core/auth';
import { CoupleStore } from '../../core/couple';
import { Home, Wish } from '../../core/models';
      ...
      @if (loading()) {
        ...
        <div class="card daily-panel">
          ...
          <div class="summary-grid">
            ...
            <a class="summary-item" routerLink="/us/wishlist">
              <div class="metric-row"><span>想一起做</span><svg lucideSparkles size="18"></svg></div>
              <b>{{ wishes().length }}</b>
            </a>
...
export class HomePage implements OnInit {
  ...
  dailyHeadline() {
    ...
    if (events) return `今天有 ${events} 個行程要一起照顧`;
